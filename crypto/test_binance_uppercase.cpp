...
int main() {
    std::cout << "=== 使用大写BINANCE密钥的加解密测试 ===" << std::endl;
    ...
    std::string key = "BINANCE";  // 使用大写BINANCE
    ...
    try {
        // 测试BlowFish加解密
        std::cout << "\n--- BlowFish 加解密测试 (原始版本使用大写BINANCE) ---" << std::endl;
        ...
        // 测试TwoFish加解密
        std::cout << "\n--- TwoFish 加解密测试 (原始版本使用大写BINANCE) ---" << std::endl;
        ...
        if (key_match && secret_match && twofish_key_match && twofish_secret_match) {
            std::cout << "\n✅ 所有测试通过！原始版本使用大写BINANCE密钥工作正常。" << std::endl;
        } else {
            std::cout << "\n❌ 部分测试失败！" << std::endl;
        }
        
        std::cout << "\n=== 与修复版本结果对比 ===" << std::endl;
        std::cout << "原始版本BlowFish加密结果应该与修复版本一致（都使用大写BINANCE）" << std::endl;
